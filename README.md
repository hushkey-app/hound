<p align="center">
  <img src="www/static/logo.svg" width="120" alt="Hound" />
</p>

<h1 align="center">hound</h1>

<p align="center">
  Deno-native Redis job queue. Sorted-set delivery, crash recovery via Reaper,<br/>
...
```ts
import { Hound } from "jsr:@hushkey/hound";
...
await management.api.jobs.pause("default:jobId");          // freeze until resumed
...
The Reaper is a background sweep that handles crash recovery without Redis Streams or PEL. It starts automatically with `hound.start()` and stops with `hound.stop()`.
